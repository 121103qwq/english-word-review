...
同一套 Vite + TypeScript 核心输出单文件离线 HTML、Tauri 2 Windows 应用和 Capacitor 8 Android 应用。当前 8.2.1 发布线将学习进度与内容镜像完整整合进设置，并采用 v7.4.6 重构版的 39 词内置词库；原有三种学习模式、检查背诵和 `weighted-random-v1` 抽题算法保持不变。
