...
同一套 Vite + TypeScript 核心输出单文件离线 HTML、Tauri 2 Windows 应用和 Capacitor 8 Android 应用。当前 8.2.0 发布线增加独立的平台个性化设置与快捷键中心；原有三种学习模式、检查背诵和 `weighted-random-v1` 抽题算法保持不变。
